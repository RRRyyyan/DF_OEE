...
namespace PMCDash.Models
{
    ...
    {
        public AlarmStatistics(string alarmMSg, int times, double totalMin)
        {
            AlarmMSg = alarmMSg;
            Times = times;
            TotalMin = totalMin;
    ...
    public class AlarmPercent
    {
        public AlarmPercent(string alarmMSg, double Times_Ratio, double Min_Ratio)
        {
            AlarmMSg = alarmMSg;
        ...
        /// 總次數比例
        /// </summary>
        public double times_ratio { get; set; }
        /// <summary>
        /// 總時間比例
        /// </summary>
        public double min_Ratio { get; set; }
    }
